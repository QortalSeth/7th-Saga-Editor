...
public class EquipmentData
{
    ...
    {
	weapons.sortList((Comparator<Weapon>) models.lists.Equipment.ascendingComparator);
    ...
    {
	armors.sortList((Comparator<Armor>) models.lists.Equipment.ascendingComparator);
	for (Armor a : armors.getModels())
	{
