...
public class AbstractItems<T extends AbstractItem> extends Models<T> implements Serializable
{
	...
	// {
	// models.add((T) new Item(i, listIndex++));
	// }
	// }
	//
	...
	// {
	// models.add((T) new Weapon(w, listIndex++));
	// }
	// }
	//
	...
	// {
	// models.add((T) new Armor(a, listIndex++));
	// }
	// }
    }
    ...
    public static final Comparator<? extends models.Equipment> descendingCostComparator	= new Comparator<models.Equipment>()
											{
											    @Override
    ...
    public static final Comparator<? extends models.Equipment> ascendingCostComparator	= new Comparator<models.Equipment>()
											{
											    @Override
											    public int compare(models.Equipment e1, models.Equipment e2)
											    {
