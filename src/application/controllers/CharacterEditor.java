...
{
    private application.models.Character	  previouslySelectedCharacter;
    ...
    {
	saveData();
	application.models.Character character = charactersC.getSelectionModel().getSelectedItem();
	application.models.Character Dcharacter = characters.getDModel(character);
    ...
    {
	application.models.Character c = previouslySelectedCharacter;
	if (c == null) { return; }
    ...
    @FXML
    private ComboBox<application.models.Character>	charactersC;
    @FXML
