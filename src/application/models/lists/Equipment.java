...
public class Equipment<T extends application.models.Equipment> extends AbstractItems<T> implements Serializable
{
	public Equipment()
	{
		super();
	...
	{
		application.models.Equipment emptyEquipment = new application.models.Equipment(0);
	...
	{
		for (application.models.Equipment equipment : addFrom.getModels())
		{
...
//	}
	...
	public static final Comparator<? extends application.models.Equipment> ascendingComparator	= new Comparator<application.models.Equipment>()
	{
		@Override
	...
	public static final Comparator<? extends application.models.Equipment> descendingComparator	= new Comparator<application.models.Equipment>()
	{
		@Override
		public int compare(application.models.Equipment e1, application.models.Equipment e2)
		{
	...
	public static final Comparator<? extends application.models.Equipment> ascendingTypeComparator	= new Comparator<application.models.Equipment>()
	{
		@Override
		public int compare(application.models.Equipment e1, application.models.Equipment e2)
		{
	...
	public static final Comparator<? extends application.models.Equipment> descendingTypeComparator	= new Comparator<application.models.Equipment>()
	{
		@Override
		public int compare(application.models.Equipment e1, application.models.Equipment e2)
		{
