...
public class Characters extends Models<application.models.Character> implements Serializable
{
    ...
    @Override
    public void initializeModel(List<application.models.Character> models)
    {
    ...
    {
	for (application.models.Character c : models)
	    c.writeValuesToROM();
    }
    ...
    // characters.add(application.models.get(3));
    // characters.add(application.models.get(4));
    // characters.add(application.models.get(1));
    // characters.add(application.models.get(0));
    // characters.add(application.models.get(6));
    // characters.add(application.models.get(5));
    // characters.add(application.models.get(2));
    //
    // ObservableList<Character> Dcharacters = FXCollections.observableArrayList();
    // Dcharacters.add(application.models.get(3));
    // Dcharacters.add(application.models.get(4));
    // Dcharacters.add(application.models.get(1));
    // Dcharacters.add(application.models.get(0));
    // Dcharacters.add(application.models.get(6));
    // Dcharacters.add(application.models.get(5));
    // Dcharacters.add(application.models.get(2));
    //
